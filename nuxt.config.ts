...
export default defineNuxtConfig({
      ...
      link: [
        {
          ...
          rel: "icon",
          type: "image/x-icon",
          href: `/img/sites/${process.env.NUXT_ENV_SITE_NAME.toLowerCase().replace(/\s+/g, "-")}/favicon.ico`,
        },
  ...
  runtimeConfig: {
    public: {
      ...
      apiUpdateLeadUrl:
        process.env.NUXT_ENV_API_UPDATE_LEAD_URL ||
        "https://register-api.net/api/update",
